'''
Version of main file where generator is conditioned over class labels and discriminator is
responsible for both prediction tasks (real/fake and class label).

This is used in the paper: Conditional Image Synthesis With Auxiliary Classifier GANs.

SFD = 1:
MAX RTS EPOCH: 63 value: 0.5203650981748051
MIN STS EPOCH: 25 value: 0.7697877883911133
MIN SFD EPOCH: 66 value: 1.0226422548294067
(best epoch seems to be 65 or so)

Author: Skyler Norgaard, Nate Burley
'''
import numpy as np
import sys
...
D_loss_weight = 1 #real / synthetic prediction loss weight
D_loss_weight2 = 1 #class label prediction loss weight
#KEEP THIS SET TO 0 IN THIS CASE, MAKES IT SO IT'S IGNORED IN TRAINING
#AND ITS INCORPORATED INTO THE LOSS OF THE DISCRIMINATOR WHICH IS RESPONSIBLE FOR BOTH
C_loss_weight = 0 
SFD_loss_weight = float(SFD_loss)

#LOAD THE PRE-TRAINED CLASSIFIER
#NOT BEING USED WITHIN MODEL HERE (kept for evaluation to help understand generated data during training)
