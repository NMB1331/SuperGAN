...
THIS IS THE VERSION WHERE C_loss_weight IS SET TO 0. THIS MEANS THAT A CLASSIFIER IS NOT
INCLUDED IN THE TRAINING. THIS IS ALMOST EXACTLY THE ARCHITECTURE OF https://arxiv.org/pdf/1706.02633.pdf
...
fpath_data, fpath_classifier, class_label, model_save_directory, SFD_loss, outfile = input.parse_input_file(input_file)
X,y,y_onehot = input.load_data_full(fpath_data)
